...
Le verger expérimental (que l'on apellera aussi parcelle par la suite) n\textdegree1 a une superficie de 0.33 hectares et est séparé en trois sous-parcelles.
...
\begin{figure}[ht]
 ...
 \begin{tikzpicture}[scale = 0.4]
  ...
  \draw (9, 10) node{\text{ \footnotesize Paillage}};
  \draw (9, 9) node{\text{ \footnotesize synthétique}};
  \draw (9, 7.7) node{\text{ \footnotesize (45 arbres)}};
  \draw (3, 10) node{\text{ \footnotesize Enherbement}};
  \draw (3, 9) node{\text{ \footnotesize ras}};
  \draw (3, 7.7) node{\text{ \footnotesize (49 arbres)}};
  \draw (15, 10) node{\text{ \footnotesize Enherbement}};
  \draw (15, 9) node{\text{ \footnotesize haut}};
  \draw (15, 7.7) node{\text{ \footnotesize (59 arbres)}};
...
\caption{Comparaison des différentes dynamiques d'inflorescences vivantes du verger n\textdegree1 en fonction du \emph{dataset} utilisé. Coefficients de mise à l'échelle : $\alpha_{\text{ER}} = 73.1$; $\alpha_{\text{PS}} = 51.7$; $\alpha_{\text{EH}} = 70.1.$}
\label{fig:inflos}
\end{figure}
